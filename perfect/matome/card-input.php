...
<body>
    ...
    <h1>カード情報登録</h1>
    <?php
    echo '<form action="card-output.php" method="post">';
    echo '<p>';
    ...
    echo '<input id="card_date" type="text" required maxlength="5" pattern="\d{2}/?\d{2}" name="card_date">';
    echo '</p>';
    
    echo '<br>';
    echo ' <p><button name="touroku-button"type="submit" class="card">登録</button></p>';
    echo '</form>';
    ?>
    <div class="ori">
